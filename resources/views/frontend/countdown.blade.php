...
<body data-currency="$">
				...
				<div class="row">
					<div class="column large-2">
						<div class="logo-wrapper">
							<img src="../../../public/html/images/logo.png" alt="" class="logo-image">
						</div>
					</div>
			...
			<div class="header-container">
				<div class="header-wrapper">
					<div class="header-content">
						<div class="row">
							<div class="columns large-12 page-quote-block">
								<h2 class="page-quote timer-sale-title"><span class="title-text">20% off on winter warmers</span></h2>
							</div>
							<div class="column large-12">
								<div class="countdown-block" data-color="#4ba6e7" data-date="2015-01-01 00:00:00"></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="carousel-block">
					<div class="owl-header">
						<ul class="slides header-carousel">
							<li><img src="http://placehold.it/1900x1267" alt=""></li>
							<li><img src="http://placehold.it/1900x1267" alt=""></li>
							<li><img src="http://placehold.it/1900x1267" alt=""></li>
							<li><img src="http://placehold.it/1900x1267" alt=""></li>
						</ul>
		...
		<section role="main">
								...
								<div class="column large-4 medium-6">
									<div class="news-item js-news-item">
										<div class="news-image-block news-with-slider">
											<img src="../../../public/html/images/placeholder.png" class="news-placeholder" alt="">
			...
			<section class="video-section">
				...
				<video preload="auto" loop class="video-block js-page-video" poster="http://placehold.it/1280x720">
			        <source src="../../../public/html/video/MOTO-HD.mp4" type="video/mp4">
			        <source src="../../../public/html/video/MOTO-HD.webm" type="video/webm">
		...
		<footer>
			<section class="get-in-touch l-section-padding bg-img" id="contacts">
				...
				<div class="fields-view">
					<form action="../../../public/html/sendmail.php" method="post">
						<div class="row">
								...
								<div class="logo-wrapper">
									<div class="logo-block">
										<a href="#main-carousel">
											<img src="../../../public/html/images/footer-logo.png" alt="" class="footer-logo"/>
										</a>
									</div>
								</div>
							</div>
	...
	<script data-main="js/script.js" src="../../../public/html/js/lib/require.js"></script>
</body>
@endsection
